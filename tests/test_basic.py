...
def test_type_conversion_annotated():
    ...
    data = {"a" : 10, "b": 20.5, "ccc": 30, "x" : {"y" : {"d": 40}}, 
            "e": 50, "extra_field": 100 } 
    ref_data = {"a" : 10, "b": 20, "c": '30', "d": 40, "e": 50, 'f': 3} 
...
def test_type_conversion_advanced_annotated():
    ...
    @typecast
    class A:
        def __init__(self, a: Any, b: int, c:Annotated[B, Path('ccc')], d:float, e=2, f=3) -> None:
            self.a = a
            self.b = b
            self.c = c 
            self.d = d 
